...
experiment = xlsread('../New_exp_signal/Sample14_bot.xlsx');
simulation_data1 = xlsread('../Experimental_signal/Sample16_sim.xlsx');
...
writematrix(final_signal/10^12/scaling, [exp_out,'Sample14_bot.txt']);